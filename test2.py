...
image = cv2.imread('/Users/Jannik/Desktop/MultimediaDatabaseProject/lenna_cropped.jpg', 0)
...
cv2.imwrite('custom_2d_convolution_gx_2.png',sobelxImage)
cv2.imwrite('custom_2d_convolution_gy_2.png',sobelyImage)
cv2.imwrite('custom_2d_convolution_gradient_2.png',sobelGrad)